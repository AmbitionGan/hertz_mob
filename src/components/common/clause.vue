<template>
  <div class="clause-page">
    ...
    <div class="contents">
      <span class="bold-color">Trademarks.</span>
      We or our affiliates own registered service marks including, without limitation, "Hertz," "Hertz #1 Club," "Hertz #1 Club Gold," "Hertz Neverlost", “Hertz Rent2Buy”, “Hertz Car Sales,” “Hertz Equipment Rental” , Firefly Car Rental, Connect by Hertz and certain unregistered marks. Names, logos and other marks identifying our products or services are our or our affiliates’ proprietary marks, and are protected by United States and international trademark laws. All other trademarks and service marks used on this website are the trademarks, service marks, or logos of their respective owners.
    </div>

    <div class="contents">
      <span class="bold-color">Privacy.</span>
    ...
    <div class="contents">
      <span class="bold-color">Registration.</span>
    ...
    <div class="contents">
      <span class="bold-color">Code of Conduct.</span>
      While using this website and/or the Site Materials, you agree not to:
      <ul>
        <li>Restrict or inhibit any other visitor from using this website, including, without limitation, by means of "hacking," "denial of service" attacks or defacing any portion of this website;</li>
        <li>Use this website or the Site Materials for any unlawful or unauthorized purpose;</li>
        ...
        <li>Modify, adapt, sub-license, translate, sell, transfer, reverse engineer, decompile, or disassemble any portion of this website or the Site Materials;</li>
        <li>"Frame" or "mirror" any part of this website without our prior written authorization;</li>
        <li>Tamper in any way with the software or functionality of this website, including, without limitation, transmitting or posting any software or other materials to this website that contains any viruses, time bombs, Trojan horses, worms, cancelbots or other computer programming routines that may damage, interfere with, intercept, or expropriate any system, data, or information;</li>
        <li>Use any robot, spider, site search/retrieval application, or other manual or automatic device or process to retrieve, index, "data mine," or in any way reproduce or circumvent the navigational structure or presentation of this website or its contents;</li>
        <li>Harvest or collect information about visitors to this website without their express consent;</li>
        <li>Create a database by systematically downloading and storing all or any of the information on this website;</li>
        <li>Make postings of a commercial nature; or</li>
        <li>Permit others, including those whose accounts were terminated, to access this website through your account, username or password.</li>
        <li></li>
      </ul>
    </div>
    <div
      class="contents"
    >In addition, while using this website and/or the Site Materials, you agree to comply with all applicable laws, rules, and regulations.</div>
    <div class="contents">
      <span
        class="bold-color"
      >Making Reservations and Purchasing or Requesting Products or Services.</span>
      If you wish to make reservations or to purchase or request products or services described on this website, you may be asked by us (or, if you are purchasing or requesting the product or service through a co-branded area of this website, by the provider of such product or service) to supply certain data applicable to your reservation or purchase, including, without limitation, credit card information and other personally identifiable data about you. You understand that any such personally identifiable data will be treated by us in the manner described in the privacy policy accessible via a link provided at the bottom of the homepage of this website and, if a Hertz co-branded provider is involved, such data will be treated by such provider in the manner set forth in that provider's privacy statement; you acknowledge that we are not responsible for the information collection or privacy practices of these providers or any other third parties. You agree that all data that you provide in making reservations or purchases or requesting services will be accurate, current, and complete. You agree to pay all charges incurred by you or any users of your account and credit card or other payment mechanism at the rate(s) or price(s) in effect when such charges are incurred. You will also be responsible for paying any applicable taxes relating to your purchases.
    </div>
    <div
      class="contents"
    >We reserve the right, without prior notification, to change any descriptions or images of, or references to, any products or services on this website, or to limit the order quantity on any such product or service and/or refuse service to you. We note that descriptions or images of, or references to, third party products or services do not necessarily imply our endorsement of such products or services.</div>

    <div
      class="contents"
    >Verification of submitted data may be required prior to our acceptance of any reservation, purchase or order. Except as otherwise required by law or as otherwise expressly stated by us, price, rate and availability of products or services are subject to change without notice. You acknowledge that reservations, purchases and services are subject to additional terms and conditions imposed by us or by our affiliates, licensees or associates.</div>

    <div
      class="contents"
    >A summary of our current policies regarding vehicle rental rate quotes, reservations and prepaid rentals is accessible from the web page on which you are quoted a rate for rental by us.</div>
    <div class="contents">
      <span class="bold-color">Links.</span>
    ...
    <div class="contents">
      <span class="bold-color">Use of “Cookies” and Other Tracking Technologies.</span>
    ...
    <div class="contents">
      <span class="bold-color">Accuracy of Information.</span>
    ...
    <div class="contents">
      <span class="bold-color">Disclaimers.</span>
    ...
    <div class="contents">
      <span class="bold-color">Conflicts.</span>
    ...
    <div class="contents">
      <span class="bold-color">Limitation of Liability.</span>
      ...
      <ul>
        <li>THE USE OF THIS WEBSITE, INCLUDING, BUT NOT LIMITED TO, DAMAGES RESULTING OR ARISING FROM YOUR RELIANCE ON THIS WEBSITE OR ANY INFORMATION OR MATERIALS FOUND ON THIS WEBSITE OR HYPERLINKED FROM THIS WEBSITE, OR THE MISTAKES, OMISSIONS, INTERRUPTIONS, ERRORS, DEFECTS, DELAYS IN OPERATION, TRANSMISSIONS, EAVESDROPPING BY THIRD PARTIES, OR ANY FAILURE OF PERFORMANCE OF THIS WEBSITE;</li>
        <li>GOVERNMENT RESTRICTION, STRIKES, WAR, ANY NATURAL DISASTER OR FORCE MAJEURE, POWER FAILURES, LARGE INCREASES IN ON-LINE ACTIVITY IN A SHORT PERIOD OF TIME (USAGE SPIKES), VIRUSES, CATASTROPHIC HARDWARE FAILURES, ATTACKS ON OUR SERVERS, FIRES, EARTHQUAKES, FLOODS, UNUSUALLY SEVERE WEATHER, OR ANY OTHER CONDITION BEYOND OUR REASONABLE CONTROL LIMITING, PREVENTING OR OTHERWISE AFFECTING EITHER YOUR ACCESS TO OR USE OF THIS WEBSITE OR SITE MATERIALS OR OUR ABILITY TO PROVIDE PRODUCTS OR SERVICES IN CONNECTION WITH, OR RESERVED OR ORDERED THROUGH, THIS WEBSITE; OR</li>
        <li>LOSS OF SECURITY OF INFORMATION YOU HAVE PROVIDED IN CONNECTION WITH YOUR USE OF THIS WEBSITE, OR INTERCEPTION OF ANY SUCH INFORMATION BY UNAUTHORIZED THIRD PARTIES.</li>
      </ul>
    </div>
    <div
      class="contents"
    >YOUR SOLE REMEDY FOR DISSATISFACTION WITH THIS WEBSITE AND/OR SITE MATERIALS CONTAINED WITHIN THIS WEBSITE IS TO STOP USING THIS WEBSITE AND/OR SITE MATERIALS, AS APPLICABLE.</div>
    <div class="contents">
      <span class="bold-color">Indemnification.</span>
    ...
    <div class="contents">
      <span class="bold-color">Availability of this Website.</span>
    ...
    <ul>
      ...
      <li>
        <span>Any European Union country</span>
        <span>England & Wales</span>
      </li>
      <li>
        <span>Japan</span>
      ...
      <li>
        <span>Any Middle East country</span>
        <span>England & Wales</span>
      </li>
      <li>
    ...
    <div
      class="contents"
    >If you are a citizen of any Asian country other than Japan or Korea, the laws of the State of New Jersey in the United States shall apply, without regard to New Jersey's conflict of law provisions.</div>
    <div
      class="contents"
    >Notwithstanding the foregoing, the law and forum governing any product or service that you purchase or otherwise obtain from us, our affiliates, licensees, or associates shall be as specified in the applicable contract with us pertaining to such product or service.</div>
    <div class="contents">
      <span class="bold-color">Other General Provisions.</span>
    ...
    <div class="contents">
      <span class="bold-color">Legal Notice for Canadian Residents.</span>
    ...
    <div class="contents">
      <span class="bold-color">Legal Notice for California Residents.</span>
...
.clause-page {
  font-size: 0.14rem;
  padding: 1.04rem 0.3rem 0.3rem 0.3rem;
  .title {
    font-weight: bold;
  }
  .bold-color {
