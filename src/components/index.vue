	...
	data () {
		return {
			...
			columnList: [
				...
				{src: require('@/assets/images/icon_3.jpg'), title: '驾照翻译', href: '/'},
				{src: require('@/assets/images/icon_4.jpg'), title: '保险和服务', href: '/'},
				{src: require('@/assets/images/icon_5.jpg'), title: '租车所需材料', href: '/'},
